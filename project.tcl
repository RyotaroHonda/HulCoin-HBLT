...
#
# project.tcl: Tcl script for re-creating project 'HulCoin-HBLT'
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/constr/hul_impl.xdc"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "HulCoin-HBLT"
...
set file "[file normalize "$origin_dir/constr/hul_pins.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constr/hul_pins.xdc"
set file [file normalize $file]
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constr/hul_timing.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constr/hul_timing.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "library" -value "mylib" -objects $file_obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constr/hul_impl.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constr/hul_impl.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "library" -value "mylib" -objects $file_obj
